...
function buildQuestions(purpose) {
  return [
    ...
    {
      type: 'confirm',
      message: 'Do you want to skip animal sniffer?',
      name: 'skipAnimalSniffer',
      default: true
    },
    {
      type: "checkbox",
...
function cargoQuestions(purpose) {
  return [
    ...
    },
    {
      ...
      message: 'What version of wildfly you want to use?',
      default: function() {
        return constants.wildflyVersion;
      },
      when: function(answers) {
        return answers.appserver === 'wildfly8';
      }
    },
    {
      type: 'confirm',
    ...
    },
    {
      ...
      when: function (answers) {
        return answers.appserver === 'jbosseap6' && !answers['envEAP6_URL'];
      }
    },
    {
      type: "input",
